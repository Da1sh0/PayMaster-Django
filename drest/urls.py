...
urlpatterns = [
    ...
    path('docs_inde/',include_docs_urls(title='Documentation REST Independiente')),
    path('docs1/',include_docs_urls(title='Documentation REST Calculos')),
    path('docs2/',include_docs_urls(title='Documentation REST Novedades')),
